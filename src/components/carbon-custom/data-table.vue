<template>
  <div :style="tableStyle" class="cv-data-table">
    <div class="bx--data-table-container">
      <div class="bx--data-table-header" id="header">
      ...
      <table class="bx--data-table" :class="modifierClasses" id="table">
        <thead>
          <tr>
    ...
    <cv-pagination :style="{ position: 'absolute', bottom: 0}" id="paginator"
      v-if="pagination"
...
<script>
import CvDataTableHeading from '@carbon/vue/src/components/cv-data-table/_cv-data-table-heading.vue';
...
import CvWrapper from '@carbon/vue/src/components/cv-wrapper/_cv-wrapper';
import uidMixin from '@carbon/vue/src/mixins/uid-mixin';
